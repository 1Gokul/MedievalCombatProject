...
public:
	...
	*/
	...
	// The random number generated by IdleEnd(), to be used in the Blend Poses by Int block.
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Anims")
	int32 IdleAnimSlot;
...
public:
	...
	*/
	 ...
	 *	@param RandUpperLimit - The number of idle animations available for that particular Idle state.
	 *
	 *	This Upper limit is used as the upper limit of the RandRange function, which will return a
	 *	random number from 0 to (UpperLimit - 1).
	 *	
	 ...
	 */
	UFUNCTION(BlueprintCallable)
	void IdleEnd(int32 RandUpperLimit);
